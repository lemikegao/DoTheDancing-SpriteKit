...
@interface DTDSearchingForIpadScene() <MCNearbyServiceAdvertiserDelegate>

@end

@implementation DTDSearchingForIpadScene
...
{
    // Stop advertising
    [[DTDGameManager sharedGameManager].advertiser stopAdvertisingPeer];
...
{
    MCNearbyServiceAdvertiser *advertiser = [DTDGameManager sharedGameManager].advertiser;
